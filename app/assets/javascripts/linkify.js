...
THREEx.Linkify	= function(domEvents, mesh, url, withBoundingBox){
	...
	if( withBoundingBox ){
		var boundingBox	= new THREE.Mesh(new THREE.BoxGeometry(1,1,1), new THREE.MeshBasicMaterial({
			wireframe	: true
		}))
	...
	var underline	= new THREE.Mesh(new THREE.BoxGeometry(size.x, underlineH, size.z), new THREE.MeshNormalMaterial())
